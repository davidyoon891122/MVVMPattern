...
class DogView: UIView {
    ...
    let nameLabel: UILabel = {
        ...
        nameLabel.font = UIFont(name: "AvenurNextCondensed-MediumItalic", size: 20)
    ...
    let ageLabel: UILabel = {
        ...
        ageLabel.font = UIFont(name: "AvenurNextCondensed-MediumItalic", size: 20)
    ...
    let adoptionFeeLabel: UILabel = {
        ...
        adoptionFeeLabel.font = UIFont(name: "AvenurNextCondensed-MediumItalic", size: 20)
